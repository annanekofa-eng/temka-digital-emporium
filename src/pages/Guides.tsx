...
const SECTIONS: Section[] = [
  {
    ...
    guides: [
      ...
      {
        id: "ad-creative-structure",
        title: "📌 Структура рекламного креатива",
        description: "Хук, описание, преимущества и CTA — формула рабочего поста для привлечения клиентов.",
        required_plan: "start",
        public: true,
      },
      {
        id: "client-acquisition",
        title: "📌 Варианты привлечения клиентов",
        description: "7 рабочих каналов трафика: рассылки, закуп, взаимный пиар, ЛС, розыгрыши, сарафан и сторис.",
        required_plan: "start",
        public: true,
      },
    ],
    ...
    guides: [
      {
        ...
        description: "8 практических принципов: описание, цена, трафик, ассортимент, доверие, повторные продажи и акции.",
        required_plan: "start",
        public: true,
      },
      {
        id: "earn-without-investing",
        title: "📌 Как зарабатывать не тратя",
        description: "Схема дропшипа: сначала продаёшь, потом закупаешь. Никаких вложений на старте.",
        required_plan: "start",
        public: true,
      },
    ],
