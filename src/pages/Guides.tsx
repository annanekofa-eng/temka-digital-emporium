...
const SECTIONS: Section[] = [
  {
    ...
    guides: [
      ...
      {
        id: "first-customers",
        title: "🚀 Как привлечь первых покупателей",
        description: "Рассылки, ЛС, закуп рекламы, взаимный пиар и сарафан — что реально работает на старте.",
        required_plan: "start",
        public: true,
      },
      {
        id: "ad-copy-writing",
        title: "✍️ Рекламный текст который продаёт",
        description: "Хук, описание, преимущества и CTA — структура поста, который конвертирует трафик в покупки.",
        required_plan: "start",
        public: true,
      },
    ],
  },
  {
    ...
    guides: [
      {
        id: "audience-warmup",
        title: "🔥 Прогрев аудитории и доверие",
        description: "5 этапов прогрева, инструменты доверия и ошибки, которые мешают холодному покупателю заплатить.",
        required_plan: "start",
        public: true,
      },
      {
        ...
        description: "Обязательная подписка, контент и рассылки — чтобы трафик не уходил впустую.",
        required_plan: "start",
        public: true,
      },
    ],
  },
  {
    ...
    guides: [
      {
        id: "revenue-boost",
        title: "📈 Как увеличить доход с магазина",
        description: "Описание, цена, остатки, ассортимент, повторные продажи и акции — как выжать максимум из магазина.",
        required_plan: "start",
        public: true,
      },
      {
        id: "earn-without-investing",
        title: "💸 Заработок без вложений",
        description: "Дропшип-схема: сначала продал — потом закупил. Стартуй без бюджета и риска.",
        required_plan: "start",
        public: true,
      },
      {
        id: "common-mistakes",
        title: "⚠️ Ошибки, которые убивают продажи",
        description: "Один источник трафика, нецелевая аудитория, медленная выдача — чего избегать с первого дня.",
        required_plan: "start",
        public: true,
      },
      {
        id: "referral-program",
        title: "🤝 Реферальная система платформы",
        description: "Как получать 50% с подписки приглашённых и строить пассивный доход поверх продаж.",
        required_plan: "start",
        public: true,
      },
    ],
...
const PUBLIC_GUIDE_BODIES: Record<string, string> = {
  "mailing-manual": [
  ...
  "revenue-boost": [
    "📈 <b>Как увеличить доход с магазина</b>",
    "",
    "Магазин работает — теперь задача выжать из него максимум.",
    "",
    "━━━━━━━━━━━━━━━━━━",
    "",
    "📝 <b>1. Описание товара решает всё</b>",
    "Чёткое название, цена, что конкретно входит, условия замены. Покупатель не должен задавать вопросы — всё должно быть в описании.",
    "",
    "Чем меньше вопросов — тем больше продаж.",
    "",
    "━━━━━━━━━━━━━━━━━━",
    "",
    "💰 <b>2. Цена — не демпингуй</b>",
    "Слишком низкая цена вызывает подозрение. Смотри конкурентов и ставь среднее по рынку или чуть выше с обоснованием — быстрая выдача, замена, поддержка.",
    "",
    "━━━━━━━━━━━━━━━━━━",
    "",
    "📦 <b>3. Следи за остатками</b>",
    "Пустой магазин теряет покупателей навсегда. Когда товар заканчивается — пополняй сразу. Настрой уведомления на остаток <b>5–10 штук</b>.",
    "",
    "━━━━━━━━━━━━━━━━━━",
    "",
    "🛍 <b>4. Расширяй ассортимент</b>",
    "Покупатель пришёл за одним — увидел смежный товар — купил оба. Добавляй товары которые интересны той же аудитории что уже покупает у тебя.",
    "",
    "━━━━━━━━━━━━━━━━━━",
    "",
    "🔁 <b>5. Повторные продажи</b>",
    "Покупатель который уже заплатил — самый ценный. Напоминай о себе — новые товары, акции, обновления.",
    "",
    "Один лояльный покупатель может принести больше чем десять новых.",
    "",
    "━━━━━━━━━━━━━━━━━━",
    "",
    "⚡ <b>6. Акции и дедлайны</b>",
    "Периодически делай скидки на популярные товары. Ограничение по времени или количеству создаёт срочность и мотивирует купить прямо сейчас.",
    "",
    "<i>Пример: «Акция до конца дня — аккаунты TikTok по 3$ вместо 5$. Осталось 20 штук.»</i>",
  ].join("\n"),
  "ad-copy-writing": [
    "✍️ <b>Рекламный текст который продаёт</b>",
    "",
    "Слабый текст убивает даже хороший товар. Сильный текст продаёт даже при среднем трафике.",
    "",
    "━━━━━━━━━━━━━━━━━━",
    "",
    "🎯 <b>ХУК — первые 1–2 строки</b>",
    "Человек решает читать дальше за 2 секунды. Бей в боль или удивляй. Хук должен останавливать взгляд.",
    "",
    "❌ Плохо: <i>«Продаю аккаунты Telegram»</i>",
    "✅ Хорошо: <i>«Устал искать нормальные аккаунты которые живут больше недели?»</i>",
    "",
    "<b>Варианты хуков:</b>",
    "• Боль: <i>«Надоело платить за аккаунты которые банятся?»</i>",
    "• Результат: <i>«Как я продаю 50 аккаунтов в день без единого вопроса»</i>",
    "• Провокация: <i>«Большинство продавцов теряют деньги на этом»</i>",
    "",
    "━━━━━━━━━━━━━━━━━━",
    "",
    "📝 <b>ОПИСАНИЕ — что это и для кого</b>",
    "2–3 строки. Объясни что предлагаешь и какую проблему решаешь. Без воды.",
    "",
    "<i>«Продаю аккаунты TikTok с живой активностью. Выдаю мгновенно после оплаты. Замена если не подойдёт.»</i>",
    "",
    "━━━━━━━━━━━━━━━━━━",
    "",
    "⭐ <b>ТОВАР И ПРЕИМУЩЕСТВА</b>",
    "Конкретные цифры и факты работают лучше общих слов.",
    "",
    "❌ Плохо: <i>«Высокое качество, быстрая доставка»</i>",
    "✅ Хорошо:",
    "— Аккаунты от 6 месяцев",
    "— Выдача за 30 секунд",
    ...
    "━━━━━━━━━━━━━━━━━━",
    "",
    "🚀 <b>CTA — одно чёткое действие</b>",
    "Одна кнопка. Один призыв. Не давай выбор.",
    "",
    "❌ Плохо: <i>«Можешь написать или посмотреть каталог или перейти в магазин»</i>",
    "✅ Хорошо: <i>«Открыть каталог → [ссылка]»</i>",
    "",
    "━━━━━━━━━━━━━━━━━━",
    "",
    "⚖️ <b>Правило 80/20</b>",
    "<b>80%</b> контента — полезное (гайды, советы, инсайты).",
    "<b>20%</b> — продающее.",
    "",
    "Сначала дай ценность, потом продавай. Это строит доверие которое конвертирует.",
  ].join("\n"),
  "first-customers": [
    "🚀 <b>Как привлечь первых покупателей</b>",
    "",
    "Магазин создан — теперь главная задача привести людей. Без трафика даже самый красивый магазин не продаёт.",
    "",
    "━━━━━━━━━━━━━━━━━━",
    "",
    "📨 <b>Рассылки в тематические чаты</b>",
    "Самый быстрый способ на старте. Находишь чаты где сидит твоя аудитория и размещаешь рекламный текст.",
    "",
    "<b>Чтобы не улететь в бан:</b>",
    "• Меняй текст в каждом чате — не копируй",
    "• Чередуй аккаунты — не больше 20–30 сообщений в день",
    "• Используй прогретые аккаунты с историей и аватаркой",
    "• Пиши только туда, где твой товар реально нужен",
    "",
    "━━━━━━━━━━━━━━━━━━",
    "",
    "✉️ <b>Личные сообщения активным продавцам</b>",
    "Заходишь в тематические чаты, смотришь кто активно пишет и продаёт, пишешь лично с оффером. Медленнее рассылки — но конверсия выше.",
    "",
    "<b>Как писать правильно:</b>",
    "• Не продавай сразу — сначала познакомься",
    "• Спроси как у него устроена выдача",
    "• Предложи решение под его боль",
    "• Не дави — просто покажи что есть вариант лучше",
    "",
    "━━━━━━━━━━━━━━━━━━",
    "",
    "💵 <b>Закуп рекламы в каналах</b>",
    "Когда появятся первые деньги — платное размещение в тематических каналах даёт стабильный поток.",
    "",
    "<b>Как выбрать канал:</b>",
    "• Смотри на охваты, а не на подписчиков",
    "• Читай комментарии — живая ли аудитория",
    "• Проси статистику у админа",
    "• Начинай с небольших каналов — дешевле и проще тестировать",
    "",
    "━━━━━━━━━━━━━━━━━━",
    "",
    "🤝 <b>Взаимный пиар</b>",
    "Находишь магазин или канал со схожей аудиторией и предлагаешь взаимную рекламу. Бесплатно и эффективно.",
    "",
    "━━━━━━━━━━━━━━━━━━",
    "",
    "⭐ <b>Сарафанное радио</b>",
    "Самый ценный трафик. Довольный покупатель рассказывает друзьям — они приходят уже с доверием.",
    "",
    "Чтобы запустить сарафан — просто делай то что обещал, выдавай быстро, решай проблемы без скандала.",
  ].join("\n"),
  "earn-without-investing": [
    "💸 <b>Заработок без вложений</b>",
    "",
    "Один из лучших способов старта без бюджета — сначала продать, потом закупить. Это дропшиппинг или работа под заказ.",
    "",
    "━━━━━━━━━━━━━━━━━━",
    "",
    "⚙️ <b>Как это работает</b>",
    "<b>Шаг 1.</b> Размещаешь товар в магазине по своей цене. Товара физически нет.",
    "<b>Шаг 2.</b> Покупатель оплачивает заказ. Деньги у тебя.",
    "<b>Шаг 3.</b> Закупаешь товар у поставщика по закупочной цене.",
    "<b>Шаг 4.</b> Выдаёшь покупателю.",
    "",
    "━━━━━━━━━━━━━━━━━━",
    "",
    "📦 <b>Как оформить выдачу</b>",
    "Так как автовыдача не работает — добавь в описание товара:",
    "",
    "<i>«Для получения заказа напишите @username»</i>",
    "",
    "Покупатель пишет сам — ты выдаёшь уже закупленный товар.",
    "",
    "━━━━━━━━━━━━━━━━━━",
    "",
    "💰 <b>Пример расчёта</b>",
    "• Закупочная цена — <b>3$</b>",
    "• Цена в магазине — <b>5$</b>",
    "• Чистая прибыль — <b>2$</b> с каждой продажи без единого вложения",
    "",
    "━━━━━━━━━━━━━━━━━━",
    "",
    "⚡ <b>Главное правило</b>",
    "Выдавай быстро. В этой нише репутация решает всё. Покупатель ждёт максимум несколько часов — не дни. Задержка = негативный отзыв и возврат.",
    "",
    "━━━━━━━━━━━━━━━━━━",
    "",
    "🔎 <b>Где искать поставщиков</b>",
    "• Тематические чаты по оптовой продаже цифровых товаров",
    "• Форумы — lolz.live, zelenka.guru",
    "• Прямые продавцы в чатах — оптом дешевле",
    "• Тариф <b>Plus</b> нашей платформы — поставщики уже включены",
  ].join("\n"),
  "audience-warmup": [
    "🔥 <b>Прогрев аудитории и доверие</b>",
    "",
    "Холодный покупатель не платит незнакомцу. Ему нужно время и причина доверять.",
    "",
    "━━━━━━━━━━━━━━━━━━",
    "",
    "🤔 <b>Почему покупатели не платят сразу</b>",
    "В голове у нового покупателя одни и те же вопросы:",
    "• Кто это?",
    "• Не скам ли?",
    "• Реально ли работает?",
    "• Стоит ли доверять?",
    "",
    "Одним рекламным сообщением их не снять. Нужна серия касаний.",
    "",
    "━━━━━━━━━━━━━━━━━━",
    "",
    "📈 <b>5 этапов прогрева</b>",
    "<b>1.</b> Привлечение внимания — цепляющий хук в рекламе",
    "<b>2.</b> Формирование интереса — полезный контент и примеры",
    "<b>3.</b> Выстраивание доверия — отзывы, скрины, открытость",
    "<b>4.</b> Создание желания — другие уже купили и довольны",
    "<b>5.</b> Побуждение к действию — один чёткий призыв",
    "",
    "━━━━━━━━━━━━━━━━━━",
    "",
    "🛠 <b>Инструменты доверия</b>",
    "<b>Отзывы</b> — самое главное. Скриншот отзыва работает лучше любой рекламы.",
    "",
    "<b>Скрины продаж</b> — статистика магазина и уведомления об оплатах. Люди видят что магазин живой.",
    "",
    "<b>Скорость выдачи</b> — мгновенная выдача = автоматическое доверие.",
    "",
    "<b>Открытость</b> — отвечай на вопросы публично, не удаляй негатив, а решай его.",
    "",
    "━━━━━━━━━━━━━━━━━━",
    "",
    "❌ <b>Ошибки, которые убивают доверие</b>",
    "• Продаёшь сразу без единого касания",
    "• Игнорируешь вопросы покупателей",
    "• Только рекламные посты без полезного контента",
    "• Пропадаешь после получения оплаты",
  ].join("\n"),
  "common-mistakes": [
    "⚠️ <b>Ошибки, которые убивают продажи</b>",
    "",
    "Учись на чужих ошибках — это дешевле.",
    "",
    "━━━━━━━━━━━━━━━━━━",
    "",
    "🎯 <b>Один источник трафика</b>",
    "Полное сосредоточение на одном канале — рассылки, один чат, один аккаунт — создаёт уязвимость. Аккаунт улетел, чат закрылся — продаж нет.",
    "",
    "Используй минимум <b>2–3 разных</b> канала привлечения.",
    "",
    "━━━━━━━━━━━━━━━━━━",
    "",
    "👥 <b>Нецелевая аудитория</b>",
    "Много переходов, но нет продаж — значит привлекаешь не тех людей.",
    "",
    "Лучше <b>50 целевых</b> покупателей, чем <b>1000 случайных</b>.",
    "",
    "━━━━━━━━━━━━━━━━━━",
    "",
    "📢 <b>Только рекламный контент</b>",
    "Канал из одних продающих постов отталкивает. Чередуй — полезный контент, отзывы, новости ниши, и только потом продажа.",
    "",
    "━━━━━━━━━━━━━━━━━━",
    "",
    "⏳ <b>Ждёшь мгновенных результатов</b>",
    "Первые продажи могут прийти не в первый день и даже не в первую неделю. Это нормально. Продолжай работать систематически.",
    "",
    "━━━━━━━━━━━━━━━━━━",
    "",
    "📊 <b>Не анализируешь что работает</b>",
    "Пиши в разные чаты с разными текстами и смотри откуда приходят покупатели. Масштабируй рабочее, отключай нерабочее.",
    "",
    "━━━━━━━━━━━━━━━━━━",
    "",
    "🐌 <b>Медленная выдача</b>",
    "В нише цифровых товаров покупатель ждёт мгновенно. Задержка на несколько часов без предупреждения = жалоба и возврат.",
    "",
    "<b>Автовыдача</b> решает проблему полностью — настрой её правильно.",
  ].join("\n"),
  "referral-program": [
    "🤝 <b>Реферальная система платформы</b>",
    "",
    "Простой способ зарабатывать, не продавая товары.",
    "",
    "━━━━━━━━━━━━━━━━━━",
    "",
    "⚙️ <b>Как это работает</b>",
    "Приглашаешь друга или знакомого по своей реферальной ссылке. Когда он оплачивает подписку — ты автоматически получаешь <b>50%</b> от его оплаты на свой счёт.",
    "",
    "━━━━━━━━━━━━━━━━━━",
    "",
    "🔗 <b>Где взять ссылку</b>",
    "<b>Профиль → Реферальная система → Скопировать ссылку</b>",
    "",
    "━━━━━━━━━━━━━━━━━━",
    "",
    "🎯 <b>Кому предлагать</b>",
    "• Знакомым которые продают что-то в Telegram вручную",
    "• Продавцам в тематических чатах без нормального магазина",
    "• Тем кто жалуется на ручную выдачу товаров",
    "",
    "━━━━━━━━━━━━━━━━━━",
    "",
    "💬 <b>Как предлагать</b>",
    "Не спамь ссылкой всем подряд. Сначала выяви потребность — расспроси как человек продаёт, какие проблемы. Потом предложи платформу как решение.",
    "",
    "Так конверсия будет в разы выше.",
    "",
    "━━━━━━━━━━━━━━━━━━",
    "",
    "💰 <b>Математика</b>",
    "При тарифе <b>Plus</b> 7$/мес — ты получаешь <b>3.5$</b> с каждой оплаты.",
    "",
    "• <b>10</b> рефералов = <b>35$/мес</b> пассивно",
    "• <b>50</b> рефералов = <b>175$/мес</b> пассивно",
    "",
    "Это дополнительный доход поверх продаж в твоём магазине.",
  ].join("\n"),
};
