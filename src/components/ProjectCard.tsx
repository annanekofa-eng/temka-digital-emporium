...
const ProjectCard = ({ project, index }: Props) => {
  ...
  return (
    ...
    >
      <Link
        to={`/p/${project.id}`}
        className="group relative block overflow-hidden rounded-2xl border border-primary/40 bg-card p-4 transition-all hover:border-primary hover:-translate-y-0.5"
        style={{
          boxShadow:
