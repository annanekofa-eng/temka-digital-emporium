                ...
                <div className="relative flex flex-col bg-card min-h-0">
                  <div className="flex-1 overflow-y-auto p-5 sm:p-8 flex flex-col gap-3 sm:gap-4 pb-[calc(env(safe-area-inset-bottom)+5.5rem)] md:pb-8">
                    ...
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="group relative block overflow-hidden rounded-xl border border-white/70 bg-white/5 hover:bg-white/10 px-4 pt-2.5 pb-4 shadow-[0_0_18px_rgba(255,255,255,0.25)] transition-colors"
                    >
