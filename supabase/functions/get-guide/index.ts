...
const GUIDES: Record<string, { required_plan: Plan; section: string; title: string; body: string }> = {
  // attraction
  "attr-tg-ads": { required_plan: "start", section: "attraction", title: "Реклама в Telegram-каналах", body: "" },
  "attr-organic": { required_plan: "basic", section: "attraction", title: "Органический рост: контент и SEO", body: "" },
  "attr-influencers": { required_plan: "premium", section: "attraction", title: "Работа с инфлюенсерами и блогерами", body: "" },
  // clients
  "cli-onboarding": { required_plan: "start", section: "clients", title: "Онбординг покупателя в боте", body: "" },
  "cli-support": { required_plan: "basic", section: "clients", title: "Поддержка и обработка возвратов", body: "" },
  "cli-loyalty": { required_plan: "premium", section: "clients", title: "Система лояльности и удержания", body: "" },
  // revenue
  "rev-upsell": { required_plan: "basic", section: "revenue", title: "Допродажи и кросс-сейл", body: "" },
  "rev-pricing": { required_plan: "basic", section: "revenue", title: "Ценообразование цифровых товаров", body: "" },
  "rev-automation": { required_plan: "premium", section: "revenue", title: "Автоворонки и реактивация", body: "" },
};
